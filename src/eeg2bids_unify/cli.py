...
# Usage: uv run python -m eeg2bids_unify.cli convert --file data.vhdr --bids-root ./output --subject 01 --session 01 --task ssvep
...
@click.group()
def cli():
    """eeg2bids-unify — Convert heterogeneous EEG files to BIDS format."""
    pass
